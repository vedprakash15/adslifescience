package com.august.common.util;
...
{
    File schemaFile = new File("C:/Users/Ved Prakash/Desktop/100program/guestSchema.json");
    File jsonFile = new File("C:/Users/Ved Prakash/Desktop/100program/data.json");
    	
    if (JsonValidationUtils.isJsonValid(schemaFile, jsonFile)){
